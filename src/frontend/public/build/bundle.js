...
var app = (function () {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			add_location(p, file$8, 52, 8, 1340);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_catch_block_1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*res*/ 1 && t_value !== (t_value = /*error*/ ctx[9].message + "")) set_data_dev(t, t_value);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function create_pending_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$8, 56, 10, 1392);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(55:20)             <p>Loading...</p>          {:then items}",
    		ctx
    	});
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			add_location(p, file$8, 77, 8, 1914);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "Loading...";
    			add_location(p, file$8, 81, 10, 1966);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(80:20)             <p>Loading...</p>          {:then items}",
    		ctx
    	});
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$8, 68, 10, 1640);
    			add_location(li0, file$8, 67, 8, 1625);
    			attr_dev(button1, "class", "button large next");
    			add_location(button1, file$8, 71, 10, 1769);
    			add_location(li1, file$8, 70, 8, 1754);
    			attr_dev(ul, "class", "actions pagination");
    			add_location(ul, file$8, 66, 6, 1585);
    			attr_dev(div0, "id", "main");
    			add_location(div0, file$8, 50, 4, 1286);
    			attr_dev(div1, "id", "wrapper");
    			add_location(div1, file$8, 47, 2, 1244);
    			add_location(main, file$8, 44, 0, 1215);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
