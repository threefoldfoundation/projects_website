...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file, 9, 9, 188);
    			attr_dev(form, "class", "search");
    			attr_dev(form, "method", "get");
    			attr_dev(form, "action", "#");
    			add_location(form, file, 8, 8, 133);
    			add_location(section0, file, 7, 7, 115);
    			add_location(h30, file, 18, 11, 392);
    			add_location(p0, file, 19, 11, 424);
    			attr_dev(a0, "href", "#");
    			add_location(a0, file, 17, 10, 368);
    			add_location(li0, file, 16, 9, 353);
    			add_location(h31, file, 24, 11, 539);
    			add_location(p1, file, 25, 11, 574);
    			attr_dev(a1, "href", "#");
    			add_location(a1, file, 23, 10, 515);
    			add_location(li1, file, 22, 9, 500);
    			add_location(h32, file, 30, 11, 687);
    			add_location(p2, file, 31, 11, 724);
    			attr_dev(a2, "href", "#");
    			add_location(a2, file, 29, 10, 663);
    			add_location(li2, file, 28, 9, 648);
    			add_location(h33, file, 36, 11, 843);
    			add_location(p3, file, 37, 11, 883);
    			attr_dev(a3, "href", "#");
    			add_location(a3, file, 35, 10, 819);
    			add_location(li3, file, 34, 9, 804);
    			attr_dev(ul0, "class", "links");
    			add_location(ul0, file, 15, 8, 325);
    			add_location(section1, file, 14, 7, 307);
    			attr_dev(a4, "href", "#");
    			attr_dev(a4, "class", "button large fit");
    			add_location(a4, file, 46, 13, 1071);
    			add_location(li4, file, 46, 9, 1067);
    			attr_dev(ul1, "class", "actions stacked");
    			add_location(ul1, file, 45, 8, 1029);
    			add_location(section2, file, 44, 7, 1011);
    			attr_dev(section3, "id", "menu");
    			add_location(section3, file, 4, 5, 65);
    			add_location(h2, file, 59, 10, 1320);
    			add_location(strong, file, 60, 13, 1355);
    			add_location(p4, file, 60, 10, 1352);
    			attr_dev(div0, "class", "title");
    			add_location(div0, file, 58, 9, 1290);
    			add_location(header, file, 57, 8, 1272);
    			if (img.src !== (img_src_value = "images/pic01.png")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "");
    			add_location(img, file, 63, 37, 1518);
    			attr_dev(span, "class", "image featured");
    			add_location(span, file, 63, 8, 1489);
    			attr_dev(p5, "class", "home_tf");
    			add_location(p5, file, 64, 8, 1571);
    			attr_dev(p6, "class", "home_tf");
    			add_location(p6, file, 65, 8, 1851);
    			attr_dev(p7, "class", "home_tf");
    			add_location(p7, file, 66, 16, 2145);
    			attr_dev(p8, "class", "home_tf");
    			add_location(p8, file, 67, 16, 2468);
    			attr_dev(p9, "class", "home_tf");
    			add_location(p9, file, 68, 8, 2533);
    			attr_dev(article, "class", "post");
    			add_location(article, file, 56, 7, 1241);
    			attr_dev(div1, "id", "main");
    			add_location(div1, file, 53, 5, 1197);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 19, 2, 750);
    			attr_dev(a1, "href", a1_href_value = "#/projects/" + /*project*/ ctx[0].name);
    			attr_dev(a1, "class", "button large");
    			add_location(a1, file$1, 22, 10, 867);
    			add_location(li0, file$1, 22, 6, 863);
    			attr_dev(ul0, "class", "actions");
    			add_location(ul0, file$1, 21, 4, 836);
    			attr_dev(a2, "href", "#");
    			add_location(a2, file$1, 25, 10, 993);
    			add_location(li1, file$1, 25, 6, 989);
    			attr_dev(ul1, "class", "stats");
    			add_location(ul1, file$1, 24, 4, 964);
    			add_location(footer, file$1, 20, 2, 823);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			add_location(p, file$8, 41, 8, 1112);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_pending_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$8, 45, 10, 1164);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(44:20)             <p>Loading...</p>          {:then items}",
    		ctx
    	});
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			add_location(p, file$8, 66, 8, 1643);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "Loading...";
    			add_location(p, file$8, 70, 10, 1695);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(69:20)             <p>Loading...</p>          {:then items}",
    		ctx
    	});
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file$8, 57, 10, 1412);
    			add_location(li0, file$8, 56, 8, 1397);
    			attr_dev(a1, "href", "#");
    			attr_dev(a1, "class", "button large next");
    			add_location(a1, file$8, 60, 10, 1517);
    			add_location(li1, file$8, 59, 8, 1502);
    			attr_dev(ul, "class", "actions pagination");
    			add_location(ul, file$8, 55, 6, 1357);
    			attr_dev(div0, "id", "main");
    			add_location(div0, file$8, 39, 4, 1058);
    			attr_dev(div1, "id", "wrapper");
    			add_location(div1, file$8, 36, 2, 1016);
    			add_location(main, file$8, 33, 0, 987);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$9($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		...
    		$$invalidate(3, projects = selected_projects);
    	...
    	return [res, miniProjects, users, projects, url];
    }

    class Projects extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$9, create_fragment$9, safe_not_equal, { url: 4 });
    ...
    function create_fragment$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a1, "href", "/");
    			add_location(a1, file$e, 14, 12, 247);
    			add_location(li0, file$e, 13, 10, 230);
    			attr_dev(a2, "href", "/projects");
    			add_location(a2, file$e, 17, 12, 320);
    			add_location(li1, file$e, 16, 10, 303);
    			attr_dev(a3, "href", "/users");
    			add_location(a3, file$e, 20, 12, 405);
    			add_location(li2, file$e, 19, 10, 388);
    			add_location(nav0, file$e, 12, 8, 214);
