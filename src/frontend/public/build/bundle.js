...
var app = (function () {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			add_location(p, file$4, 29, 8, 724);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_pending_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 33, 10, 776);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(32:20)             <p>Loading...</p>          {:then items}",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			add_location(p, file$4, 72, 8, 1682);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_pending_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			p.textContent = "Loading...";
    			add_location(p, file$4, 76, 10, 1734);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(75:20)             <p>Loading...</p>          {:then items}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t7 = space();
    			p0 = element("p");
    			t8 = text("Another fine responsive site template by\n            ");
    			a3 = element("a");
    			a3.textContent = "HTML5 UP";
    			t10 = space();
    			if_block1.c();
    			t11 = space();
    			...
    			t27 = space();
    			p2 = element("p");
    			t28 = text("© Untitled. Design:\n          ");
    			a10 = element("a");
    			a10.textContent = "HTML5 UP";
    			t30 = text("\n          . Images:\n          ");
    			a11 = element("a");
    			a11.textContent = "Unsplash";
    			t32 = text("\n          .");
    			t33 = space();
    			...
    			add_location(a0, file$4, 45, 10, 1032);
    			add_location(li0, file$4, 44, 8, 1017);
    			attr_dev(a1, "href", "#");
    			attr_dev(a1, "class", "button large next");
    			add_location(a1, file$4, 48, 10, 1137);
    			add_location(li1, file$4, 47, 8, 1122);
    			attr_dev(ul0, "class", "actions pagination");
    			add_location(ul0, file$4, 43, 6, 977);
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$4, 60, 10, 1369);
    			attr_dev(a2, "href", "#");
    			attr_dev(a2, "class", "logo");
    			add_location(a2, file$4, 59, 8, 1333);
    			add_location(h20, file$4, 63, 10, 1446);
    			attr_dev(a3, "href", "http://html5up.net");
    			add_location(a3, file$4, 66, 12, 1551);
    			add_location(p0, file$4, 64, 10, 1482);
    			add_location(header, file$4, 62, 8, 1427);
    			attr_dev(section0, "id", "intro");
    			add_location(section0, file$4, 58, 6, 1304);
    			add_location(h21, file$4, 90, 8, 2079);
    			add_location(p1, file$4, 91, 8, 2102);
    			attr_dev(a4, "href", "#");
    			attr_dev(a4, "class", "button");
    			add_location(a4, file$4, 98, 12, 2405);
    			add_location(li2, file$4, 97, 10, 2388);
    			attr_dev(ul1, "class", "actions");
    			add_location(ul1, file$4, 96, 8, 2357);
    			attr_dev(section1, "class", "blurb");
    			add_location(section1, file$4, 89, 6, 2047);
    			attr_dev(span0, "class", "label");
    			add_location(span0, file$4, 108, 14, 2657);
    			attr_dev(a5, "href", "#");
    			attr_dev(a5, "class", "icon brands fa-twitter");
    			add_location(a5, file$4, 107, 12, 2599);
    			add_location(li3, file$4, 106, 10, 2582);
    			attr_dev(span1, "class", "label");
    			add_location(span1, file$4, 113, 14, 2813);
    			attr_dev(a6, "href", "#");
    			attr_dev(a6, "class", "icon brands fa-facebook-f");
    			add_location(a6, file$4, 112, 12, 2752);
    			add_location(li4, file$4, 111, 10, 2735);
    			attr_dev(span2, "class", "label");
    			add_location(span2, file$4, 118, 14, 2969);
    			attr_dev(a7, "href", "#");
    			attr_dev(a7, "class", "icon brands fa-instagram");
    			add_location(a7, file$4, 117, 12, 2909);
    			add_location(li5, file$4, 116, 10, 2892);
    			attr_dev(span3, "class", "label");
    			add_location(span3, file$4, 123, 14, 3119);
    			attr_dev(a8, "href", "#");
    			attr_dev(a8, "class", "icon solid fa-rss");
    			add_location(a8, file$4, 122, 12, 3066);
    			add_location(li6, file$4, 121, 10, 3049);
    			attr_dev(span4, "class", "label");
    			add_location(span4, file$4, 128, 14, 3268);
    			attr_dev(a9, "href", "#");
    			attr_dev(a9, "class", "icon solid fa-envelope");
    			add_location(a9, file$4, 127, 12, 3210);
    			add_location(li7, file$4, 126, 10, 3193);
    			attr_dev(ul2, "class", "icons");
    			add_location(ul2, file$4, 105, 8, 2553);
    			attr_dev(a10, "href", "http://html5up.net");
    			add_location(a10, file$4, 134, 10, 3423);
    			attr_dev(a11, "href", "http://unsplash.com");
    			add_location(a11, file$4, 136, 10, 3495);
    			attr_dev(p2, "class", "copyright");
    			add_location(p2, file$4, 132, 8, 3356);
    			attr_dev(section2, "id", "footer");
    			add_location(section2, file$4, 104, 6, 2523);
    			attr_dev(section3, "id", "sidebar");
    			add_location(section3, file$4, 55, 4, 1253);
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a0, file$5, 8, 6, 123);
    			add_location(h1, file$5, 7, 4, 112);
    			attr_dev(a1, "href", "/home");
    			add_location(a1, file$5, 14, 12, 251);
    			add_location(li0, file$5, 13, 10, 234);
    			attr_dev(a2, "href", "/projects");
    			add_location(a2, file$5, 17, 12, 328);
    			add_location(li1, file$5, 16, 10, 311);
    			attr_dev(a3, "href", "/users");
    			add_location(a3, file$5, 20, 12, 413);
    			add_location(li2, file$5, 19, 10, 396);
    			add_location(nav0, file$5, 12, 8, 218);
    			add_location(ul0, file$5, 11, 6, 205);
    			attr_dev(nav1, "class", "links");
    			add_location(nav1, file$5, 10, 4, 179);
    			attr_dev(a4, "class", "fa-search");
    			attr_dev(a4, "href", "#search");
    			add_location(a4, file$5, 28, 10, 575);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "name", "query");
    			attr_dev(input0, "placeholder", "Search");
    			add_location(input0, file$5, 30, 12, 687);
    			attr_dev(form0, "id", "search");
    			attr_dev(form0, "method", "get");
    			attr_dev(form0, "action", "#");
    			add_location(form0, file$5, 29, 10, 632);
    			attr_dev(li3, "class", "search");
    			add_location(li3, file$5, 27, 8, 545);
    			attr_dev(a5, "class", "fa-bars");
    			attr_dev(a5, "href", "#menu");
    			add_location(a5, file$5, 34, 10, 811);
    			attr_dev(li4, "class", "menu");
    			add_location(li4, file$5, 33, 8, 783);
    			add_location(ul1, file$5, 26, 6, 532);
    			attr_dev(nav2, "class", "main");
    			add_location(nav2, file$5, 25, 4, 507);
    			attr_dev(header, "id", "header");
    			add_location(header, file$5, 6, 2, 87);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "name", "query");
    			attr_dev(input1, "placeholder", "Search");
    			add_location(input1, file$5, 45, 8, 1034);
    			attr_dev(form1, "class", "search");
    			attr_dev(form1, "method", "get");
    			attr_dev(form1, "action", "#");
    			add_location(form1, file$5, 44, 6, 980);
    			add_location(section0, file$5, 43, 4, 964);
    			add_location(h30, file$5, 54, 12, 1226);
    			add_location(p0, file$5, 55, 12, 1259);
    			attr_dev(a6, "href", "#");
    			add_location(a6, file$5, 53, 10, 1201);
    			add_location(li5, file$5, 52, 8, 1186);
    			add_location(h31, file$5, 60, 12, 1373);
    			add_location(p1, file$5, 61, 12, 1409);
    			attr_dev(a7, "href", "#");
    			add_location(a7, file$5, 59, 10, 1348);
    			add_location(li6, file$5, 58, 8, 1333);
    			add_location(h32, file$5, 66, 12, 1521);
    			add_location(p2, file$5, 67, 12, 1559);
    			attr_dev(a8, "href", "#");
    			add_location(a8, file$5, 65, 10, 1496);
    			add_location(li7, file$5, 64, 8, 1481);
    			add_location(h33, file$5, 72, 12, 1677);
    			add_location(p3, file$5, 73, 12, 1718);
    			attr_dev(a9, "href", "#");
    			add_location(a9, file$5, 71, 10, 1652);
    			add_location(li8, file$5, 70, 8, 1637);
    			attr_dev(ul2, "class", "links");
    			add_location(ul2, file$5, 51, 6, 1159);
    			add_location(section1, file$5, 50, 4, 1143);
    			attr_dev(a10, "href", "#");
    			attr_dev(a10, "class", "button large fit");
    			add_location(a10, file$5, 83, 10, 1903);
    			add_location(li9, file$5, 82, 8, 1888);
    			attr_dev(ul3, "class", "actions stacked");
    			add_location(ul3, file$5, 81, 6, 1851);
    			add_location(section2, file$5, 80, 4, 1835);
    			attr_dev(section3, "id", "menu");
    			add_location(section3, file$5, 40, 2, 919);
    			add_location(div, file$5, 5, 0, 79);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
